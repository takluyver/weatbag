...
class Tile:
    ...
    def describe(self):
        if not self.give_catfood:
            print("You are at the beach and there is an old man with an enormous "
              "beard that is geting his little boat ready to go across to the "
              "mainland.\nNaturally you are asking him to take you in his "
              "boat.\nThe old man replies:\nOf course I can take you with me my "
              "dear adventurer but first I need some catfood so I can feed the "
              "kitties across in the mainland!")
        else:
